...
class PasswordResetConfirmView(FormView):
    """
    This view handles the actual password reset.

    For a user that has forgotten their password. The view first checks the hash
    in a password reset link and then presents a form to enter a new password.
    """
...
class UserRegistrationView(FormView):
    ...
    # email and subject line for the message sent to the HELP admins
    ...
    # email and subject line for the message sent to the potential HELP user
