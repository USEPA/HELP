...
!           below which the soil is assumed to be freezing, hardcoded 32.0
!
...
!
      SUBROUTINE READIN (F4, F7, F13, F11, F10)

      CHARACTER(len=60), INTENT(IN) :: F4
      CHARACTER(len=60), INTENT(IN) :: F7
      CHARACTER(len=60), INTENT(IN) :: F13
      CHARACTER(len=60), INTENT(IN) :: F11
      CHARACTER(len=60), INTENT(IN) :: F10
