! *****************************************************************
 ...
 1050          CONTINUE
      ...
      IF (NL .EQ. 13 .or. NL .EQ. 42 .or. (NL .EQ. 0 .and. (NH &
            .EQ. 79 .or. NH .EQ. 72 .or. &
            NH .EQ. 73 .or. NH .EQ. 80 .or. NH .EQ. 81 .or. &
            NH .EQ. 82 .or. NH .EQ. 83 &
            .or. NH .EQ. 71 .or. NH .EQ. 1)) .or. NL .EQ. 27) THEN
!
...
! *****************************************************************
 ...
 1030 CONTINUE
      ...
      IF ((NL .GE. 48 .AND. NL .LE. 57) .OR. NL .EQ. 46 .OR. NL .EQ. 32 &
            .OR. NL .EQ. 43 .OR. NL .EQ. 45 .OR. NL .EQ. &
             69 .OR. NL .EQ. 101) THEN
         ITEMP = NL
...
!
 ...
 6000 FORMAT('               ษอออออออออออออออออออออออออออออออออออออออ', &
      'อออออออป',/, &
      '               บ   Do you wish  to enter another              ', &
      'บ',/, &
      '               บ   year of data to this data set?  Yes   No   ', &
      'บ',/, &
      '               บ                                              ', &
      'บ',/, &
      '               บ                                              ', &
      'บ',/, &
      '               ศออออออออออออออออออออออออออออออออออออออออออออออ', &
      'ผ')
      NA = 12
      NBSTART = 49
...
!
 ...
 6000 FORMAT('               ษอออออออออออออออออออออออออออออออออออออออ', &
      'อออออออป',/, &
      '               บ   Data file already exists in                ', &
      'บ',/, &
      '               บ   the edit file.  Do you wish     Yes   No   ', &
      'บ',/, &
      '               บ   to append data to it?                      ', &
      'บ',/, &
      '               บ                                              ', &
      'บ',/, &
      '               ศออออออออออออออออออออออออออออออออออออออออออออออ', &
...
!
 ...
 6000 FORMAT('               ษอออออออออออออออออออออออออออออออออออออออ', &
      'อออออออป',/, &
      '               บ   Data set has one value missing             ', &
      'บ',/, &
      '               บ   for leap year.  Do you want                ', &
      'บ',/, &
      '               บ   to add this year of data to     Yes   No   ', &
      'บ',/, &
      '               บ   the data set?                              ', &
      'บ',/, &
      '               บ                                              ', &
 ...
 6010 FORMAT('               ษอออออออออออออออออออออออออออออออออออออออ', &
      'อออออออป',/, &
      '               บ   Data set has extra data.  Do you wish      ', &
      'บ',/, &
      '               บ   to use the first 365 (or 366)              ', &
      'บ',/, &
      '               บ   data values?  Extra data will   Yes   No   ', &
      'บ',/, &
      '               บ   be ignored.                                ', &
      'บ',/, &
      '               บ                                              ', &
